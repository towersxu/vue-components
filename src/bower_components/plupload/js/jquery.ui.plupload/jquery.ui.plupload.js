...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {Boolean} [settings.multiple_queues=true] Re-activate the widget after each qiniu-upload procedure.
*/
...
/**
Dispatched when qiniu-upload is started.
...
/**
Dispatched when qiniu-upload is stopped.
...
/**
Dispatched during the qiniu-upload process.
...
/**
Dispatched when qiniu-upload of the whole queue is complete.
			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_text">' + _("Add files to the qiniu-upload queue and click the start button.") + '</div>' +
...
$.widget("ui.plupload", {
	...
	/**
	Start qiniu-upload. Triggers `start` event.
	...
	*/
	...
	/**
	Stop qiniu-upload. Triggers `stop` event.
